...
**Website:** https://github.com/CrisQiu/my_research_project
...
Jiahui Qiu (2026).
*My Research Project* (Version 0.1.0).
University of Oulu.
DOI: 
...
```bibtex
@software my_research_project,
  author = Jiahui Qiu,
  title = My Research Project,
  year = 2026,
  version = 0.1.0,
  doi = ,
  url = https://github.com/CrisQiu/my_research_project
}
```
or
